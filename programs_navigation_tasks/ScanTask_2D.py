...
from exp_functions import initial_exp, make_distribute, show_stimuli, mkImg, mkText, run_introduction, findShortest, \
    checkChoice, initialise_D3, follow_D2
...
dim_list = randchoice(all_dim_list, 2, replace=False)
keyList = ['1', '2', '3', '4']
...
for thisRun in range(nRoute):
    ...
    file_list, bestChoice, finalChoices, choice_list = follow_D2(material, session, trial_type, cur, goal, dim_list,
                                                               space_shape, keyList)
    ...
    while RouteContinue:
        ...
        if cur == goal:
            ...
            if block == 1:
                ...
                trial_type = 'normal'
            file_list, infoList, finalChoices, choice_list = follow_D2(material, session, trial_type, cur, goal,
